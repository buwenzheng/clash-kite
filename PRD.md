...
| 延迟实时显示     | 从 mihomo history 取最新延迟，替代固定 "--"                  | 未开始 | [proxy-module.md](docs/proxy-module.md) |
| 延迟颜色编码     | 绿色 <200ms / 黄色 <500ms / 红色 ≥500ms / 灰色超时          | 未开始 | [proxy-module.md](docs/proxy-module.md) |
| 节点排序         | 按延迟升序 / 按名称 / 默认顺序，支持切换                    | 未开始 | [proxy-module.md](docs/proxy-module.md) |
| 节点类型显示     | 显示协议类型（SS/VMess/Trojan/Hysteria2/VLESS 等）           | 未开始 | [proxy-module.md](docs/proxy-module.md) |
| 测速并发控制     | 限制同时测速数量（默认 50），防止网络拥堵                    | 未开始 | [proxy-module.md](docs/proxy-module.md) |
